# Contributing to im-capaciteitskaart

:+1: First of all: Thank you for taking the time to contribute!

The following is a set of guidelines for contributing to
im-capaciteitskaart. These guidelines are not strict rules.
...
The im-capaciteitskaart team strives to create a
...
- Pull Requests
    ...
    - PRs should be reviewed and merged in a timely fashion by the im-capaciteitskaart technical leads
...
[issues]: https://github.com/Netbeheer-Nederland/im-capaciteitskaart/issues/
[pulls]: https://github.com/Netbeheer-Nederland/im-capaciteitskaart/pulls/
