...
-- # Class: "HeatmapDataSet" Description: "Represents a HeatmapDataSet"
...
--     * Slot: name Description: A human-readable name for a thing
--     * Slot: description Description: A human-readable description for a thing
--     * Slot: HeatmapDataSetCollection_id Description: Autocreated FK slot
-- # Class: "HeatmapDataSetCollection" Description: "A holder for HeatmapDataSet objects"
--     * Slot: id Description: 
...
CREATE TABLE "HeatmapDataSetCollection" (
	id INTEGER NOT NULL, 
	PRIMARY KEY (id)
);
CREATE TABLE "HeatmapDataSet" (
	...
	name TEXT, 
	description TEXT, 
	"HeatmapDataSetCollection_id" INTEGER, 
	PRIMARY KEY (id), 
	FOREIGN KEY("HeatmapDataSetCollection_id") REFERENCES "HeatmapDataSetCollection" (id)
);